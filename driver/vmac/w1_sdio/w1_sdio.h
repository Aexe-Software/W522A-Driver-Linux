...
/* set_usb_bt_power() lives in Amlogic kernel's USB power management.
 * On Armbian we provide an empty stub so the vmac can link without
 * depending on Amlogic out-of-tree symbols. */
...
/* Module init/exit prototypes (suppress -Wmissing-prototypes) */
