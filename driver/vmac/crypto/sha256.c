...
/**
 * aml_hmac_sha256_vector - HMAC-SHA256 over data vector (RFC 2104)
		       ...
		       const u8 *addr[], const size_t *len, u8 *mac)
{
	...
	/* the aml_hmac_sha256 transform looks like:
	 *
...
/**
 * aml_hmac_sha256 - HMAC-SHA256 over data buffer (RFC 2104)
 * @key: Key for HMAC operations
 * @key_len: Length of the key in bytes
